...
5bis. Tenter un modèle **LOESS** avec prudence (uniquement descriptif , aucun pouvoir de généralisation)
...
Pour notre exemple: On conserve $H_0$, i.e. les deux variables sont **indépendantes**,  car $\chi ^2 \approx 26 > 4.303$

Interprétation: «la forme n'est pas liée à la couleur dans cette population, nous pouvons l'affirmer avec un risque d'erreur à 5%»
